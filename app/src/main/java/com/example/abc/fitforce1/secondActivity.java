...
public class secondActivity extends NavigationDrawer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = layoutInflater.inflate(R.layout.activity_second, null, false);
        ...
        if(bodyfat==0)
        {
            ...
            Prefs.addingCalorieExpenditurePrefs(secondActivity.this, String.valueOf(tddeDouble));
            bmrResultText.setText(""+bmr);

            Prefs.addingBMRPrefs(secondActivity.this,""+bmr);
    ...
    public void onReturn(View view) {
        Intent swapIntent = new Intent(this, BMR.class);
        startActivity(swapIntent);
    }

    public void onProceed(View view) {
        Intent swapIntent = new Intent(this, GoalActivity.class);
        startActivity(swapIntent);
        finish();
    }
